...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('evening_edication_ins', function (Blueprint $table) {
            $table->id();

            $table->unsignedBigInteger('eveningedicationcategory_id')->nullable()->unsigned();
            $table->foreign('eveningedicationcategory_id')
            ->references('id')
            ->on('evening_edication_categories')
            ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('evening_edication_ins');
    }
};
