...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('admission_master_ins', function (Blueprint $table) {
            $table->id();

            $table->unsignedBigInteger('admissionmastercategory_id')->nullable()->unsigned();
            $table->foreign('admissionmastercategory_id')
            ->references('id')
            ->on('admission_master_categories')
            ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('admission_master_ins');
    }
};
