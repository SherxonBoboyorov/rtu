...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add Tuition fees</h4>
                </div>
            </div>
        ...
        <form action="{{ route('tuition.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_table_uz" class="my-editor" id="content_table_uz" cols="30" rows="10"></textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_table_ru" class="my-editor" id="content_table_ru" cols="30" rows="10"></textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_table_en" class="my-editor" id="content_table_en" cols="30" rows="10"></textarea>
