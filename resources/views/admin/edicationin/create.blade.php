...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add Extramural Education Directions</h4>
                </div>
            </div>
        ...
        <form action="{{ route('edicationin.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            <label>Extramural Education Faculties</label>
                            <select name="edicationcategory_id" id="edicationcategory_id" class="form-control">
                                @foreach ($edicationcategories as $edicationcategory)
                                    <option value="{{ $edicationcategory->id }}">{{ $edicationcategory->title_en }}</option>
                                @endforeach
                            </select>
