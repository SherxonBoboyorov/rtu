                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="title_uz" value="{{ $partner->title_uz }}" class="form-control" name="title_uz">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="title_ru" value="{{ $partner->title_ru }}" class="form-control" name="title_ru">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="title_en" value="{{ $partner->title_en }}" class="form-control" name="title_en">
